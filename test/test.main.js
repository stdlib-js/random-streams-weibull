...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a Weibull distribution', function test( t ) {
	var iStream;
	var result;
	var rand;
	var opts;
...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a Weibull distribution (object mode)', function test( t ) {
	var iStream;
	var count;
	var rand;
	var opts;
