...
```bash
npm install @stdlib/random-streams-weibull
```
...
```bash
npm install -g @stdlib/random-streams-weibull
```
...
[test-image]: https://github.com/stdlib-js/random-streams-weibull/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/random-streams-weibull/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-weibull
